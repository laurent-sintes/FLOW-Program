...
Cette vue doit être lue comme une chaîne de transformation.
...
Cette étape transforme les produits et capacités en fonctionnalités consommables et en solutions concrètes.
...
La méthodologie FLOW suit une logique progressive :
