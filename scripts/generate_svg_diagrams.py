...
def render_overview_svg() -> str:
    product_cards = [
        ProductCard(
            ...
            body="Produits, assortiments, agreements, prix et conditions utiles à l'exécution.",
        ),
        ProductCard(
            x=470,
            y=420,
        ...
        ProductCard(
            ...
            body="Services Supply exposés : APIs, SLA, éligibilités et contraintes d'appel.",
        ),
    ]
    ...
    svg_lines.extend(
        [
            ...
            text_element("smallWhite", 472, 278, "Le Case porte la demande, son contexte, ses décisions"),
            text_element("smallWhite", 492, 302, "métier, ses promesses, documents et événements."),
            ...
            text_element("txt", 112, 286, "Disponibilité, réservations,"),
            text_element("txt", 112, 310, "allocations, facts et events"),
            text_element("txt", 112, 334, "stock exploitables."),
            "",
            rect("panelSoft", 928, 220, 270, 132),
            text_element("h", 958, 256, "Réseau d'Exécution"),
            text_element("txt", 958, 286, "Lieux, partenaires, capacités,"),
            text_element("txt", 958, 310, "contraintes et conditions"),
            text_element("txt", 958, 334, "mobilisables."),
            "",
